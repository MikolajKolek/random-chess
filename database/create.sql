...
(
    ...
    "service_game_id"   INT             UNIQUE NOT NULL     REFERENCES "service_games" ("id"),
    "pgn_game_id"       INT             UNIQUE NOT NULL     REFERENCES "pgn_games" ("id"),
    --
    CHECK (("service_game_id" IS NOT NULL)::int + ("pgn_game_id" IS NOT NULL)::int = 1)
);
