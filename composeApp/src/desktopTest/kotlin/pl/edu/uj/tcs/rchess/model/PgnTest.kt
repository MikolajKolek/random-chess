...
class PgnTest {
    ...
    fun fullMetadataTest() {
        ...
        Assert.assertEquals(boardStateFens(pgn), listOf(
        ...
        Assert.assertEquals(pgn.result, GameResult.BLACK_WON)
        Assert.assertEquals(pgn.metadata!!.toMap().mapValues { it.value.jsonPrimitive.content },
            mapOf(
        ...
        Assert.assertEquals(pgn.blackPlayerName, "hipo01_02")
        Assert.assertEquals(pgn.whitePlayerName, "german11")
    }
    ...
    fun pgnDatabaseTest() {
        ...
        Assert.assertEquals(boardStateFens(pgns[0]), listOf(
            "rnbqkbnr/pppppppp/8/8/4P3/8/PPPP1PPP/RNBQKBNR b KQkq e3 0 1",
            "rnbqkbnr/pppp1ppp/8/4p3/4P3/8/PPPP1PPP/RNBQKBNR w KQkq e6 0 2",
            "rnbqkbnr/pppp1ppp/8/4p3/4P3/5N2/PPPP1PPP/RNBQKB1R b KQkq - 1 2",
            "rnbqkbnr/ppp2ppp/3p4/4p3/4P3/5N2/PPPP1PPP/RNBQKB1R w KQkq - 0 3",
        ...
        Assert.assertEquals(boardStateFens(pgns[1]), listOf(
            "rnbqkbnr/pppppppp/8/8/4P3/8/PPPP1PPP/RNBQKBNR b KQkq e3 0 1",
            "rnbqkbnr/ppp1pppp/3p4/8/4P3/8/PPPP1PPP/RNBQKBNR w KQkq - 0 2",
            "rnbqkbnr/ppp1pppp/3p4/8/4P3/5N2/PPPP1PPP/RNBQKB1R b KQkq - 1 2",
        ...
        Assert.assertEquals(boardStateFens(pgns[2]), listOf(
            "rnbqkbnr/pppppppp/8/8/4P3/8/PPPP1PPP/RNBQKBNR b KQkq e3 0 1",
